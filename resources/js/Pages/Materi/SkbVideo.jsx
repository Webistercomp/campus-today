...
export default function SkdVideo({ title }) {
    return (
        <AuthenticatedLayout>
            <Head title={title} />
            ...
            <div className="text-sm breadcrumbs my-6">
                <ul>
                    ...
                    <li>
                        <Link href={route("materi.skd")}>Materi SKD</Link>
                    </li>
                    <li>{title}</li>
                </ul>
            </div>
            ...
            <section>
                ...
                <div className="flex gap-6 mt-6">
                    <Link
                        href={route("materi.skd.video.twk")}
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <p className="text-black">TWK - Judul Materi</p>
                        </div>
                    </Link>
                    <Link
                        href={route("materi.skd.video.twk")}

...
export default function TryOutSKD({ title, tryouts }) {
    return (
        <AuthenticatedLayout>
            <Head title={title} />
            ...
            <section>
                ...
                <div className="mt-6 grid grid-cols-3 gap-3">
                    {tryouts.map(function(tryout, i) {
                        return <div className="bg-white shadow-lg basis-1/3 rounded-xl p-4 flex gap-4 items-center cursor-pointer hover:bg-slate-100 duration-150 transition-all">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <div className="flex gap-3">
                                    <span className="text-slate-400 flex items-center gap-1">
                                        ...
                                        <p className="text-sm">{tryout.jumlah_soal} Soal</p>
                                    </span>
                                    <span className="text-slate-400 flex items-center gap-1">
                                ...
                                <Link href={route("tryout.confirm", tryout.id)}>

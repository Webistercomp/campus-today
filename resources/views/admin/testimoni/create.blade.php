            ...
            <table>
                <tbody>
                    ...
                    <tr class="row">
                        ...
                        <td class="col-8">
                            <textarea type="text" class="form-control" id="testimoni" name="testimoni"></textarea>
                        </td>
                    </tr>
                    <tr class="row">
                        ...
                        <td class="col-8">
                            <div class="form-floating">
                                <input class="form-control" name="institusi_sebelumnya" id="institusi_sebelumnya">
                            </div>
                        </td>
                    </tr>
                    <tr class="row">
                        ...
                        <td class="col-8">
                            <div class="form-floating">
                                <input class="form-control" name="institusi_sekarang" id="institusi_sekarang">
                            </div>
                        </td>
                    </tr>
                    <tr class="row">
                        ...
                        <td class="col-8">
                            <div id="new-image" style="display: none;">
                                <img src="" alt="" style="width: 200px; height: 200px; object-fit: cover; border-radius: 50%">
                            </div>
